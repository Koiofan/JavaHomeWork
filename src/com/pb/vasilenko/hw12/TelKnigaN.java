...
import com.pb.vasilenko.hw11.ElementTelKnig;
...
public class TelKnigaN {

    static Scanner scan = new Scanner(System.in);
    static ArrayList<com.pb.vasilenko.hw12.ElementTelKnigN> spisokKontaktov = new ArrayList<>();
    ...
    public static void main(String[] args) throws ParseException, IOException, ClassNotFoundException {
        ...
        while (true){
            ...
            list.add("==========Дейстивя: =======");
            list.add("Добавить контакт: нажмите 1.");
            list.add("Найти контакт: нажмите 2.");
            list.add("Изменить контакт: нажмите 3.");
            list.add("Вывести контакты по алфавиту: нажмите 4.");
            list.add("Вывести контакты по дате рождения: нажмите 5.");
            list.add("Удалить контакт: нажмите 10.");
            list.add("Сохранить контакты: нажмите 6.");
            list.add("Загрузить контакты: нажмите 7.");
            list.add("Выход: нажмите 0.");
            list.add("");
            list.add("==========Сделайте ваш выбор=======");
            list.stream()
    ...
    private static void KontaktDobav() throws ParseException {
        ...
        spisokKontaktov.add(new com.pb.vasilenko.hw12.ElementTelKnigN(ima, spisTel, dataRozhd, adres, dataIzmen));
        System.out.println("");
    ...
    private static void SortKontakt(String tipSort){
        ...
        if(tipSort.equals("i")){
            ...
            for (com.pb.vasilenko.hw12.ElementTelKnigN kontakt : spisokKontaktov) {
    ...
    private static void ZagruzTelKniga(String imaTelKnig) throws IOException, ClassNotFoundException {
        ...
        for (int nomK = 0; nomK < spisokKontaktovLHM.size(); nomK++ ) {
            spisokKontaktov.add(new ElementTelKnigN((String) spisokKontaktovLHM.get(nomK).get("ima"),
